    ...
    <div className="w-full h-auto  py-8 font-['Jost']">
      <div className="w-[65%] max-[1180px]:w-[75%] mx-auto max-lg:w-[90%] max-md:w-full  max-lg:px-3 h-[75vh] flex flex-col justify-center items-center ">
        ...
        <p className="py-8 px-15 max-lg:px-3 max-lg:text-md text-center text-lg ">
          ...
          sustenance; it’s an experience. We bring you a carefully crafted menu,
          designed to tantalize your taste buds and satisfy your cravings. From
          freshly prepared appetizers to hearty main courses and indulgent
          desserts, every dish is made with love and passion.
        </p>
<Button/>
      </div>
    </div>
