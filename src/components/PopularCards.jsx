          ...
          >
            <div className="popular-card group w-[270px] h-[320px] mb-4 mx-auto rounded-lg overflow-hidden relative font-['Jost']">
              ...
              <div className="relative w-[250px] h-[300px]">
                ...
                <div className="absolute inset-0 bg-red-500 h-0 group-hover:h-[100px] transition-h duration-300 top-50  z-10"></div>
              </div>
        ...
        <>
          {popular_card_data.map(
            ({ card_image, card_title, card_description }) => (
              <div className="popular-card group w-[270px] h-[320px] rounded-lg overflow-hidden relative font-['Jost']">
                {/* Image Container */}
                <div className="relative w-[250px] h-[300px]">
                  <img
                    src={card_image}
